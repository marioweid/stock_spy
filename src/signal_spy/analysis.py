...
async def analyze(
    ...
    *,
    ...
    prompt = build_prompt(quote, fundamentals, technicals, news, holding=holding, notes=notes)
...
def assemble_report(
    ...
    *,
    ...
    """Combine market data + LLM view with the deterministic quality and protection engines."""
    scores = composite(
