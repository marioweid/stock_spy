"""Entry point: produce a one-off report, or run the protection/opportunity monitor."""
...
from stock_spy.scheduler import run_forever, run_once, run_report
...
def _parse_args() -> argparse.Namespace:
    ...
    monitor_parser = sub.add_parser("monitor", help="Protect holdings and scout swing entries.")
