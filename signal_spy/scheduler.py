...
from signal_spy.analysis import analyze, assemble_report, build_agent
from signal_spy.config import Secrets
...
from signal_spy.providers.prices import get_quote
from signal_spy.report import format_summary, render_markdown
...
async def run_report(config: AppConfig, secrets: Secrets, ticker: str) -> str:
    ...
    bundle = assemble_report(quote, fundamentals, technicals, report, holding=holding)
