...
from signal_spy.analysis import analyze, assemble_report, build_prompt
...
def test_assemble_report_scores_a_holding() -> None:
...
def test_assemble_report_without_holding() -> None:
    bundle = assemble_report(_quote(100.0), Fundamentals(), Technicals(), _report(), holding=None)
